...
def section(title, icon="chart"):
    icons = {
        ...
        <svg viewBox="0 0 24 24">
            ...
            <path d="M7 7H4a3 3 0 0 0 3 3M17 7h3a3 3 0 0 1-3 3"/>
        </svg>
        """,
        ...
        "chart": """
        <svg viewBox="0 0 24 24">
            <path d="M4 19V5M4 19h16M7 15l3-4 3 2 5-6"/>
        </svg>
        """,
    }
    ...
    st.markdown(
        f"""
        <div style="display:flex;align-items:center;gap:11px;margin:18px 0 14px;">
            <div style="
                width:36px;
                height:36px;
                display:flex;
